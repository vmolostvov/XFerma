...
async def main():
    driver = await cdp_driver.start_async(proxy="vmolostvov96_gmail_com-country-us-type-mobile-ipv4-true-sid-dc1d0ac661594-filter-medium:e3ibl6cpq4@gate.nodemaven.com:8080")
